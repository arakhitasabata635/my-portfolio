    ...
    <>
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-10">
          <div className="absolute top-20 left-20 w-20 h-20 rounded-full gradient-primary opacity-20 animate-float"></div>
          <div
            className="absolute top-40 right-32 w-16 h-16 rounded-lg gradient-accent opacity-30 animate-float"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute bottom-32 left-1/4 w-12 h-12 rounded-full gradient-primary opacity-15 animate-float"
            style={{ animationDelay: "1s" }}
          ></div>
        </div>
        <div className="relative z-20 container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div
              className="animate-fade-in flex items-center justify-center gap-2 text-muted-foreground mb-8"
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="lucide lucide-arrow-down w-6 h-6 text-muted-foreground"
          >
            <path d="M12 5v14"></path>
            <path d="m19 12-7 7-7-7"></path>
          </svg>
